...
The second step is being more methodical on my exercises. In OOP we can use object calisthenics to force ourselves into the most narrow path to improve our ability to create OOP code. I have recently learned that during SOCRATES 2015, a few people did talk about exactly this, and they came with this:
